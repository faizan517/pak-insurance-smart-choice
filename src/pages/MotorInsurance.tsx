...
const MotorInsurance = () => {
  ...
  const coverages = [
    ...
    },
    {
      ...
      description: "Submit minor claims at preferred service centers without hassle.",
      icon: <FileText className="w-6 h-6 text-[#F46416]" />,
    },
    {
      title: "Zero-Claim Bonus",
      description: "Earn rewards for safe driving.",
      icon: <TrendingUp className="w-6 h-6 text-[#F46416]" />,
    },
    {
      title: "Fast Claim Settlement",
      description: "7-day turnaround and 30-second online claim lodging.",
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-normal font-[Ibrand] leading-tight">
              Motor Insurance for Cars & Bikes
              <span className="block text-3xl md:text-3xl font-normal font-[Futura] text-blue-100 mt-4">
              Protect your vehicle with flexible, technology-driven coverage
              </span>
            </h1>
      ...
      <div className="py-8">
        <Button
          ...
          className="bg-[#1D9785] text-white text-xl font-bold px-16 py-6 rounded-full shadow-2xl transition-all hover:scale-105 flex items-center gap-3 mx-auto"
        >
        Get Free Motor Insurance Quote
        <ArrowBigRightDash className="h-7 w-7 ml-2" />

        </Button>
        <QuoteForm
          insuranceType="motor"
          insuranceTypeLabel="Motor Insurance"
          open={showQuoteForm}
