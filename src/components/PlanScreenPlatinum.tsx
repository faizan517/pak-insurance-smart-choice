...
// 🔐 ENV se access key (Vite: VITE_WEB3FORMS_KEY)
...
const PlanDetails = () => {
  ...
  const planData = {
    provider: "EFU Life",
    planName: "Health Shield - Platinum",
    hospitalizationCover: "Rs. 6.5 lac per person",
    roomType: "Semi-Pvt",
    ...
    complicatedDeliveryLimit: "Rs. 300,000",
  ...
  const medicalBenefits = [
    ...
    { title: "Daycare Surgeries & Specialized Investigations", status: "Covered", info: true, benefit: "Daycare Surgeries & Specialized Investigations in Outpatient Settings Including but not Limited to: Dialysis, Cataract Surgery, MRI, CT Scan, Endoscopy, Thallium Scan, Angiography, Echo, Treatment of Fractures, Emergency Dental Treatment due to accidental injuries within 48 hours for pain relief only"},
    { title: "Pre & Post Hospitalization", status: "30 Days", info: true, benefit: "Pre-& Post Hospitalization (Covering Consultation, Medicines, and lab tests preceding admission to the hospital and after discharge from hospital)"},
    { title: "Freelook Period", status: "14 Days after the date of deduction", info: false },
    { title: "Waiting Period", status: "14 Days from the date of deduction", info: true  , benefit: "Only accidental emergencies are covered during waiting period"},
    { title: "Maternity", status: "Pay additional Rs 47,500 and get covered for up to Rs 300,000", info: false },
  ];
  ...
  // Premium math (UI summary me aap ne comment kiya hua hai; payload me bhej denge)
  const basePremium = 30500;
  const maternityAddOn = 47500;
  const maternityCover = false;
  const totalPremium = 47500
  ...
  const handleBuySubmit = async () => {
    ...
    try {
      const payload = {
        ...
        subject: `New EFU Health Shield - Platinum lead`,
                  ...
                  <table className="w-full text-sm mb-2 border border-muted rounded overflow-hidden shadow-sm">
                    ...
                    <tbody>
                      <tr className="hover:bg-muted/50 transition">
                        ...
                        <td className="py-2 px-3 border-b border-muted text-right">29,000</td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition">
                        <td className="py-2 px-3 border-b border-muted">18 - 45 yrs</td>
                        <td className="py-2 px-3 border-b border-muted text-right">20,500</td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition">
                        <td className="py-2 px-3 border-b border-muted">46 - 59 yrs</td>
                        <td className="py-2 px-3 border-b border-muted text-right">30,500</td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition">
                        <td className="py-2 px-3 border-b border-muted">60 - 65 yrs</td>
                        <td className="py-2 px-3 border-b border-muted text-right">43,500</td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition">
                        <td className="py-2 px-3 border-b border-muted">Contribution for maternity Plans (Optional Rider) *</td>
                        <td className="py-2 px-3 border-b border-muted text-right">47,500</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="rounded-lg border p-3 text-sm bg-muted/30">
                  ...
                  {/* Aap yahan premium dikhaana chaahein to uncomment karein:
                  <div className="flex items-center justify-between">
