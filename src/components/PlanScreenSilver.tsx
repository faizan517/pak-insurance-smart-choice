...
const PlanDetails = () => {
  ...
  const medicalBenefits = [
    ...
    { title: "Daycare Surgeries & Specialized Investigations", status: "Covered", info: true, benefit: "Dialysis, Cataract Surgery, MRI, CT Scan, Endoscopy, Thallium Scan, Angiography, Echo, Treatment of Fractures, Emergency Dental Treatment due to accidental injuries within 48 hours for pain relief only"},
    ...
    { title: "Maternity", status: "Pay additional Rs 17,500 and get covered for up to Rs 100,000", info: false },
  ];
  ...
  // Premium math (UI me hidden; payload me bhej sakte hain)
  const basePremium = 30500;
  const maternityAddOn = 47500;
  const maternityCover = false;
  const totalPremium = 17500
  ...
  const handleBuySubmit = async () => {
    ...
    try {
      const payload = {
        ...
        subject: `New EFU Health Shield - Silver lead`,
                  ...
                  <table className="w-full text-sm mb-2 border border-muted rounded overflow-hidden shadow-sm">
                    ...
                    <tbody>
                      <tr className="hover:bg-muted/50 transition">
                        ...
                        <td className="py-2 px-3 border-b border-muted text-right">14,500</td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition">
                        <td className="py-2 px-3 border-b border-muted">18 - 45 yrs</td>
                        <td className="py-2 px-3 border-b border-muted text-right">9,000</td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition">
                        <td className="py-2 px-3 border-b border-muted">46 - 59 yrs</td>
                        <td className="py-2 px-3 border-b border-muted text-right">15,500</td>
                      </tr>
                      <tr className="hover:bg-muted/50 transition">
                      ...
                      <tr className="hover:bg-muted/50 transition">
                        ...
                        <td className="py-2 px-3 border-b border-muted text-right">17,500</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="rounded-lg border p-3 text-sm bg-muted/30">
                  ...
                  {/* Premium ko UI me dikhana ho to uncomment karein:
                  <div className="flex items-center justify-between">
