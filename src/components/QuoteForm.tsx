...
const QuoteForm = ({
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogContent className="sm:max-w-[500px] w-full mx-auto px-4 max-h-[90vh] overflow-y-auto font-[Futuru] ">
        <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 w-full">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger>
                {insuranceType && insuranceTypeLabel ? (
                  insuranceTypeLabel
                ) : (
              ...
              <SelectContent>
                ...
                <SelectItem value="individual-health">
          ...
          {(formData.insuranceType === "individual-health" ||
            formData.insuranceType === "group-health") && (
            <div className="space-y-2">
              <Label
              ...
              <Select
                ...
                onValueChange={(v) => handleInputChange("familyMembers", v)}
              >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 font-normal font-[Ibrand] ">
            ...
            <Button
              type="submit"
              className="flex-1 bg-gradient-to-r from-[#1D9785] to-[#2ABFAF] text-white"
            >
              Get Quote
            </Button>
          </div>
